  ...
  return (
    <article>
      ...
      <Section id="outcome" kicker="Outcome" title="Validated with the people who'd bet their jobs on it">
        ...
        <p>
          Because this was the company&apos;s first AI product, what I set became the
          template. The deeper-on-fewer-things call, the citation-on-every-claim
          standard, and the voice and tone system are now how State Affairs ships
          AI, not just how these two features shipped. As the first design hire on
          AI, I was <Hi>defining the bar the next features get held to</Hi>.
        </p>
        <CaseImage
