  ...
  return (
    <div className="mx-auto grid max-w-5xl place-items-center px-6 py-40 text-center">
      <div>
        ...
        <Link
          href="/"
          className="mt-8 inline-block rounded-full bg-cta text-paper px-6 py-3 text-sm font-medium emboss-cta transition-transform hover:scale-[1.03] active:scale-[0.98]"
        >
          Back to the work
        </Link>
      </div>
