    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed inset-x-4 bottom-24 z-50 mx-auto max-w-sm overflow-hidden rounded-md px-7 py-7 text-left sm:absolute sm:inset-x-auto sm:bottom-auto sm:right-5 sm:top-full sm:mx-0 sm:mt-3 sm:w-80 sm:max-w-[calc(100vw-2rem)]"
        >
          {/* paper grain */}
          <div
            aria-hidden
