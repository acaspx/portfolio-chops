const socials = [
  ...
  },
  {
    ...
    path: "M22.539 8.242H1.46V5.406h21.08v2.836zM1.46 10.812H22.54V24l-10.54-5.91L1.46 24V10.812zM22.539 0H1.46v2.836h21.08V0z",
  },
];

/** Shared LinkedIn / GitHub / Substack icon row, used in the nav and footer. */
export default function SocialLinks({
  className = "flex items-center gap-3",
  linkClassName = "grid h-9 w-9 place-items-center rounded-lg text-muted transition-colors hover:text-accent",
