...
export default function ShareButton() {
  ...
  return (
    <button
      ...
      onClick={share}
      aria-live="polite"
      className="emboss emboss-hover flex w-full items-center justify-center gap-2.5 rounded-2xl bg-paper/70 px-5 py-2.5 text-sm text-muted transition-[color,box-shadow] duration-300 ease-out hover:text-ink sm:justify-start"
    >
      {copied ? (
